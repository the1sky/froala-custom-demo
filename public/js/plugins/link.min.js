  ...
  a.extend(a.FE.POPUP_TEMPLATES, {
    ...
    function c() {
      ...
      if (!c && b.$wp) {
        ...
        return "A" == d.tagName || b.node.isElement(d) || (d = a(d).parentsUntil(b.$el, "a:first").get(0)), "A" == e.tagName || b.node.isElement(e) || (e = a(e).parentsUntil(b.$el, "a:first").get(0)), e && e == d && "A" == e.tagName ? d : null
      }
